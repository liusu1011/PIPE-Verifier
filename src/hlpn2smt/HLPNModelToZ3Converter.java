...
//	}
	...
	//when there is replicated place types, we don't creat new type but leverage the types defined before
	...
	public String buildNewCheckerFromTemplate(String templateName, String z3str, String checkerName){
		String template = "";
		try {
			InputStream ins = new BufferedInputStream(new FileInputStream(templateName));
